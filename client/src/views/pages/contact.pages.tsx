      ...
      <div className="relative h-[40vh] md:h-[50vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center p-4">
          <div data-aos="fade-up">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Liên Hệ Với Chúng Tôi</h1>
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Chúng tôi rất mong được nghe từ bạn! Cho dù bạn có câu hỏi về thực đơn, giao hàng, hay bất cứ điều gì
              khác, đội ngũ của chúng tôi luôn sẵn sàng trả lời mọi thắc mắc của bạn.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 -mt-20 relative z-10">
          ...
          >
            ...
            <p className="text-gray-600">⌚ Thứ Hai - Thứ Sáu: 8h - 22h</p>
            <p className="text-gray-600">⌚ Cuối tuần: 10h - 23h</p>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12" data-aos="fade-up">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Tìm câu trả lời cho những câu hỏi phổ biến nhất về dịch vụ, giao hàng và các lựa chọn thực đơn của chúng
            tôi.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            <h3 className="text-xl font-semibold mb-2 text-gray-800">Bạn có cung cấp dịch vụ giao hàng không?</h3>
            <p className="text-gray-600">
              Có, chúng tôi cung cấp dịch vụ giao hàng trong phạm vi 5km từ nhà hàng. Đơn hàng có thể được đặt trực
          ...
          <div
            ...
            className="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow"
          >
            <h3 className="text-xl font-semibold mb-2 text-gray-800">Thời gian đông khách nhất là khi nào?</h3>
            <p className="text-gray-600">
              Thời gian đông khách nhất của chúng tôi thường là từ 12h-14h cho bữa trưa và 18h-20h cho bữa tối. Chúng
              tôi khuyên bạn nên đặt hàng trước trong những khoảng thời gian này.
            </p>
          </div>
          ...
          <div
            ...
            className="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow"
          >
            <h3 className="text-xl font-semibold mb-2 text-gray-800">Bạn có phục vụ cho các sự kiện không?</h3>
            <p className="text-gray-600">
              Có, chúng tôi cung cấp dịch vụ ẩm thực cho các sự kiện với mọi quy mô. Vui lòng liên hệ với chúng tôi ít
              nhất 48 giờ trước để thảo luận về yêu cầu của bạn.
            </p>
          </div>
          ...
          <div
            ...
            className="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow"
          >
            <h3 className="text-xl font-semibold mb-2 text-gray-800">Bạn có các lựa chọn cho người ăn chay không?</h3>
            <p className="text-gray-600">
              Có, chúng tôi có nhiều lựa chọn ăn chay trong thực đơn. Chúng tôi cũng có thể tùy chỉnh hầu hết các món ăn
              để phù hợp với sở thích ăn uống của bạn.
            </p>
          </div>
        </div>
      </div>
