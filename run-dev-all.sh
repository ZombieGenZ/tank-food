...
gnome-terminal --title="TANK-Food Server" -- bash -c "cd \"$(dirname "$0")/server\" && ./run-dev.sh; exec bash" &
gnome-terminal --title="TANK-Food Client" -- bash -c "cd \"$(dirname "$0")/client\" && ./run-dev.sh; exec bash" &
