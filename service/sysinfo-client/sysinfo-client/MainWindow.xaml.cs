    ...
    public partial class MainWindow : Window
    {
        ...
        private void ConnectToWebSocket()
        {
            try
            {
                ...
                ws = new WebSocket("service-stats.tank-food.io.vn/stats");
        ...
        {
            if (percentage < 50) return new SolidColorBrush(Color.FromRgb(76, 175, 80));  // Xanh lá
            if (percentage < 80) return new SolidColorBrush(Color.FromRgb(255, 152, 0));  // Cam
